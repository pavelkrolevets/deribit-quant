...
// export function probability (price, target, days, volatility) {
//   var p = price;
//   var q = target;
//   var t = days / 365;
//   var v = volatility;
...
export function black_scholes(call,S,X,r,v,t) {
...
export function option_implied_volatility(call,S,X,r,t,o) {
// call = Boolean (to calc call, call=True, put: call=false)
// S = stock prics, X = strike price, r = no-risk interest rate
// t = time to maturity
// o = option price
...
export function call_iv(s,x,r,t,o) { return option_implied_volatility(true,s,x,r/100,t/365,o) }​
