...
Start Docker Parity Secret Store

```
git clone https://github.com/Kryha/Parity-Secret-Playground
```

Instructions are here [**Parity-Secret-Playground**](https://github.com/Kryha/Parity-Secret-Playground)
